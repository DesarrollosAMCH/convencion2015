...
<head>
    ...
    <!-- Animation CSS -->
    <link href="css/front/animate.min.css" rel="stylesheet">
        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="img/front/laptop.png" alt="laptop"/>
                </div>
            </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="img/front/perspective.png" alt="dashboard" class="img-responsive">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="img/front/dashboard.png" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="img/front/avatar3.jpg" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="img/front/avatar1.jpg" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="img/front/avatar2.jpg" class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="img/front/iphone.jpg" class="img-responsive" alt="dashboard">
            </div>
